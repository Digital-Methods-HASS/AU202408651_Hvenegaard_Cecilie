---
title: "wordcloud_pr_år_Gøye.Rmd"
...
```{r}
#Følger guiden fra software carpentry 
#Med hjælp fra chatgpt fandt vi frem til at man for 2-cifret antal pdf'er skal benytte "\\d{2}\\.pdf"
...
```
```{r}
#Tjek op på at alle 11filer er tilstede 
...
```
Not surprisingly, particles are the most common words that we found. This is not particularly interesting for us in this enquiry, as we want to see which words are specific to the individual month. The particles will appear in all month. The first step is finding a measurement that will allow us to compare the frequency of words across the months. We can do this by calculating the word’s, or the term’s, frequency: 
...
```{r}
file_years <- c(
  "brev_gøye-01.pdf" = "1564.05.02",
  "brev_gøye-02.pdf" = "1564.05.02",
  "brev_gøye-03.pdf" = "1564.06.01",
  "brev_gøye-04.pdf" = "1564.06.01",
  "brev_gøye-05.pdf" = "1573.01.03",
  "brev_gøye-06.pdf" = "1580.10.19",
  "brev_gøye-07.pdf" = "1580.10.25",
  "brev_gøye-08.pdf" = "1594.09.07",
  "brev_gøye-09.pdf" = "1592.09.07",
  "brev_gøye-10.pdf" = "1591.09.07",
  "brev_gøye-11.pdf" = "1590.09.07"
  )
...
```{r}
ggsave("wordcloudBirgitteGøye.png", width = 10, height = 6, dpi = 300)
```