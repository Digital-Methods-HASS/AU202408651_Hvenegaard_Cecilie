...
date: 'created on 21 march 2025 and updated `r format(Sys.time(), "%d %B, %Y")`'
...
# as.numeric()--> Make the word "NA" 
# is.numeric filter "NA" out
...
Look back at the got report, and search for "lord" Is it typically associated with emotion, or something else? 
